...
<div class="row">
	...
	<tr>
		...
		<td>
			...
			href ="editcuststaff.php?cust_id=<?php echo $rows_cust['cust_id'];?>"> <i class="fa fa-edit "></i></button></a>
			
			<a button type="button" class="btn btn-primary btn-circle btn-lg" title="View Customer"
			href ="viewcuststaff.php?cust_id=<?php echo $rows_cust['cust_id'];?>"> <i class="fa fa-file-text-o "></i></button></a>
			
			<a button type="button" class="btn btn-primary btn-circle btn-lg" title="Delete Customer"
			href ="deletecuststaff.php?cust_id=<?php echo $rows_cust['cust_id'];?>"> <i class="fa fa-trash-o  "></i></button></a>
			</td>
	</tr>
