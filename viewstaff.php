...
<div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <h2> <?php echo $rows_view['staff_name'];?></h2>
                        </div>
                        <div class="panel-body">
<h3>Name : <?php echo $rows_view['staff_name'];?><br/> </h3> 
<h3>Email : <?php echo $rows_view['staff_email'];?><br/></h3>
<h3>Usename : <?php echo $rows_view['staff_username'];?><br/></h3>
<h3>Password : <?php echo $rows_view['staff_pass'];?><br/></h3>

<a button type="button" class="btn btn-primary btn-lg" href = "staff.php">Back</button></a>
