            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
						...
						<?php
$sql_view = "SELECT * FROM staff WHERE staff_id ='".$_GET['staff_id']."'";
...
if(isset($_POST['edit']))
{
	...
	$sql_edit = "UPDATE staff SET staff_name = 
	'".$_POST['name']."', staff_email = '".$_POST['email']."', staff_username = '".$_POST['username']."', staff_pass = '".$_POST['password']."' 
...
<form name="add-form" method="post" enctype="multipart/form-data">
	<div class="form-group">
		<label>Name</label>
		<input class="form-control" name="name" value="<?php echo $rows_view['staff_name'];?>">       
    </div>
	
	<div class="form-group">
		<label>Email</label>
		<input class="form-control" name="email" value="<?php echo $rows_view['staff_email'];?>">       
    </div>
	
	<div class="form-group">
		<label>Username</label>
		<input class="form-control" name="username" value="<?php echo $rows_view['staff_username'];?>">       
     </div>
	 
	<div class="form-group">
		<label>Password</label>
		<input class="form-control" name="password" value="<?php echo $rows_view['staff_pass'];?>">       
     </div>
